...
@JsExport
public object ECConfig {
    public val CURVE_NAME: String = "secp256k1"
    public val PRIVATE_KEY_BYTE_SIZE: Int = 32
    public val PUBLIC_KEY_COORDINATE_BYTE_SIZE: Int = 32
    public val PUBLIC_KEY_BYTE_SIZE: Int = PUBLIC_KEY_COORDINATE_BYTE_SIZE * 2 + 1
    public val PUBLIC_KEY_COMPRESSED_BYTE_SIZE: Int = PUBLIC_KEY_COORDINATE_BYTE_SIZE + 1
    public val SIGNATURE_MAX_BYTE_SIZE: Int = 72
