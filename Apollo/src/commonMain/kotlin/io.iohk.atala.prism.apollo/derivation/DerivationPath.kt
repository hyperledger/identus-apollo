...
@JsExport
public data class DerivationPath(val axes: List<DerivationAxis>) {
    public companion object {
        /** Constructs empty derivation path */
        @JvmStatic
        public fun empty(): DerivationPath = DerivationPath(emptyList())
    ...
    public fun derive(axis: DerivationAxis): DerivationPath =
        copy(axes = axes + axis)
