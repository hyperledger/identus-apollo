...
internal external var utils: Any

internal external var rand: Any

internal external var version: Number

internal external interface Coordinates {
    var x: String
    var y: String
}

internal external object curve {
    open class base {
        companion object {
...
internal external open class ec {
...
internal external open class eddsa(name: String /* "ed25519" */) {
