...
internal external open class base(type: String, conf: BaseCurveOptions) {
    open var p: Any
...
internal external open class edwards(conf: EdwardsConf) : base {
    open var a: Any
    open var c: Any
    open var c2: Any
    open var d: Any
...
internal external open class short(conf: ShortConf) : base {
