...
/**
 * This class implements the SHA-384 digest algorithm under the [MDHelper] API.
 * SHA-384 is specified by FIPS 180-2.
 */
final class SHA384 : MDHelper(false, 16), HMACInterface {
    ...
    override fun engineReset() {
        currentVal[0] = -0x344462a23efa6128L
        currentVal[1] = 0x629A292A367CD507L
        currentVal[2] = -0x6ea6fea5cf8f22e9L
        currentVal[3] = 0x152FECD8F70E5939L
        currentVal[4] = 0x67332667FFC00B31L
        currentVal[5] = -0x714bb57897a7eaefL
        currentVal[6] = -0x24f3d1f29b067059L
        currentVal[7] = 0x47B5481DBEFA4FA4L
    }
