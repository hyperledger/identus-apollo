...
final class BLAKE256 : HashingBase() {
    ...
    override fun processBlock(data: ByteArray) {
        ...
        for (r in 0..13) {
            var o0 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x0]
            var o1 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x1]
            v0 += v4 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o1])
            vC = MathHelper.circularRightInt(vC xor v0, 16)
            v8 += vC
            v4 = MathHelper.circularRightInt(v4 xor v8, 12)
            v0 += v4 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o0])
            vC = MathHelper.circularRightInt(vC xor v0, 8)
            v8 += vC
            v4 = MathHelper.circularRightInt(v4 xor v8, 7)
            o0 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x2]
            o1 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x3]
            v1 += v5 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o1])
            vD = MathHelper.circularRightInt(vD xor v1, 16)
            v9 += vD
            v5 = MathHelper.circularRightInt(v5 xor v9, 12)
            v1 += v5 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o0])
            vD = MathHelper.circularRightInt(vD xor v1, 8)
            v9 += vD
            v5 = MathHelper.circularRightInt(v5 xor v9, 7)
            o0 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x4]
            o1 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x5]
            v2 += v6 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o1])
            vE = MathHelper.circularRightInt(vE xor v2, 16)
            vA += vE
            v6 = MathHelper.circularRightInt(v6 xor vA, 12)
            v2 += v6 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o0])
            vE = MathHelper.circularRightInt(vE xor v2, 8)
            vA += vE
            v6 = MathHelper.circularRightInt(v6 xor vA, 7)
            o0 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x6]
            o1 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x7]
            v3 += v7 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o1])
            vF = MathHelper.circularRightInt(vF xor v3, 16)
            vB += vF
            v7 = MathHelper.circularRightInt(v7 xor vB, 12)
            v3 += v7 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o0])
            vF = MathHelper.circularRightInt(vF xor v3, 8)
            vB += vF
            v7 = MathHelper.circularRightInt(v7 xor vB, 7)
            o0 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x8]
            o1 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0x9]
            v0 += v5 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o1])
            vF = MathHelper.circularRightInt(vF xor v0, 16)
            vA += vF
            v5 = MathHelper.circularRightInt(v5 xor vA, 12)
            v0 += v5 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o0])
            vF = MathHelper.circularRightInt(vF xor v0, 8)
            vA += vF
            v5 = MathHelper.circularRightInt(v5 xor vA, 7)
            o0 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0xA]
            o1 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0xB]
            v1 += v6 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o1])
            vC = MathHelper.circularRightInt(vC xor v1, 16)
            vB += vC
            v6 = MathHelper.circularRightInt(v6 xor vB, 12)
            v1 += v6 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o0])
            vC = MathHelper.circularRightInt(vC xor v1, 8)
            vB += vC
            v6 = MathHelper.circularRightInt(v6 xor vB, 7)
            o0 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0xC]
            o1 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0xD]
            v2 += v7 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o1])
            vD = MathHelper.circularRightInt(vD xor v2, 16)
            v8 += vD
            v7 = MathHelper.circularRightInt(v7 xor v8, 12)
            v2 += v7 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o0])
            vD = MathHelper.circularRightInt(vD xor v2, 8)
            v8 += vD
            v7 = MathHelper.circularRightInt(v7 xor v8, 7)
            o0 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0xE]
            o1 = io.iohk.prism.apollo.hashing.BLAKE256.Companion.SIGMA[(r shl 4) + 0xF]
            v3 += v4 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o1])
            vE = MathHelper.circularRightInt(vE xor v3, 16)
            v9 += vE
            v4 = MathHelper.circularRightInt(v4 xor v9, 12)
            v3 += v4 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE256.Companion.CS[o0])
