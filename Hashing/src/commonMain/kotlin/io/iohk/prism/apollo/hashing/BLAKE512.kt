...
final class BLAKE512 : HashingBase() {
    ...
    override fun processBlock(data: ByteArray) {
        ...
        for (r in 0..15) {
            var o0 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x0]
            var o1 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x1]
            v0 += v4 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o1])
            vC = MathHelper.circularRightLong(vC xor v0, 32)
            v8 += vC
            v4 = MathHelper.circularRightLong(v4 xor v8, 25)
            v0 += v4 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o0])
            vC = MathHelper.circularRightLong(vC xor v0, 16)
            v8 += vC
            v4 = MathHelper.circularRightLong(v4 xor v8, 11)
            o0 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x2]
            o1 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x3]
            v1 += v5 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o1])
            vD = MathHelper.circularRightLong(vD xor v1, 32)
            v9 += vD
            v5 = MathHelper.circularRightLong(v5 xor v9, 25)
            v1 += v5 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o0])
            vD = MathHelper.circularRightLong(vD xor v1, 16)
            v9 += vD
            v5 = MathHelper.circularRightLong(v5 xor v9, 11)
            o0 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x4]
            o1 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x5]
            v2 += v6 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o1])
            vE = MathHelper.circularRightLong(vE xor v2, 32)
            vA += vE
            v6 = MathHelper.circularRightLong(v6 xor vA, 25)
            v2 += v6 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o0])
            vE = MathHelper.circularRightLong(vE xor v2, 16)
            vA += vE
            v6 = MathHelper.circularRightLong(v6 xor vA, 11)
            o0 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x6]
            o1 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x7]
            v3 += v7 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o1])
            vF = MathHelper.circularRightLong(vF xor v3, 32)
            vB += vF
            v7 = MathHelper.circularRightLong(v7 xor vB, 25)
            v3 += v7 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o0])
            vF = MathHelper.circularRightLong(vF xor v3, 16)
            vB += vF
            v7 = MathHelper.circularRightLong(v7 xor vB, 11)
            o0 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x8]
            o1 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0x9]
            v0 += v5 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o1])
            vF = MathHelper.circularRightLong(vF xor v0, 32)
            vA += vF
            v5 = MathHelper.circularRightLong(v5 xor vA, 25)
            v0 += v5 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o0])
            vF = MathHelper.circularRightLong(vF xor v0, 16)
            vA += vF
            v5 = MathHelper.circularRightLong(v5 xor vA, 11)
            o0 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0xA]
            o1 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0xB]
            v1 += v6 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o1])
            vC = MathHelper.circularRightLong(vC xor v1, 32)
            vB += vC
            v6 = MathHelper.circularRightLong(v6 xor vB, 25)
            v1 += v6 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o0])
            vC = MathHelper.circularRightLong(vC xor v1, 16)
            vB += vC
            v6 = MathHelper.circularRightLong(v6 xor vB, 11)
            o0 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0xC]
            o1 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0xD]
            v2 += v7 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o1])
            vD = MathHelper.circularRightLong(vD xor v2, 32)
            v8 += vD
            v7 = MathHelper.circularRightLong(v7 xor v8, 25)
            v2 += v7 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o0])
            vD = MathHelper.circularRightLong(vD xor v2, 16)
            v8 += vD
            v7 = MathHelper.circularRightLong(v7 xor v8, 11)
            o0 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0xE]
            o1 = io.iohk.prism.apollo.hashing.BLAKE512.Companion.SIGMA[(r shl 4) + 0xF]
            v3 += v4 + (m[o0] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o1])
            vE = MathHelper.circularRightLong(vE xor v3, 32)
            v9 += vE
            v4 = MathHelper.circularRightLong(v4 xor v9, 25)
            v3 += v4 + (m[o1] xor io.iohk.prism.apollo.hashing.BLAKE512.Companion.CB[o0])
