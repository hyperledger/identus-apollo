...
```kotlin
val helloWorld = "".base58BtcDecoded // "Hello, world!"
println("Welcome to IOG".base58BtcEncoded) // Prints ""
```

### Base58 Flicker

```kotlin
val helloWorld = "".base58FlickerDecoded // "Hello, world!"
println("Welcome to IOG".base58FlickerEncoded) // Prints ""
```