...
import io.iohk.atala.prism.apollo.hashing.internal.MDHelper
import io.iohk.atala.prism.apollo.hashing.internal.MathHelper

/**
 * This class implements the SHA-1 digest algorithm under the [MDHelper] API.
 * SHA-1 is defined by FIPS 180-2.
 */
final class SHA1 : MDHelper(false, 8), HMACInterface {
    ...
    override fun processBlock(data: ByteArray) {
        ...
        e = (
            (a shl 5 or (a ushr 27)) + (b xor c xor d) +
                e + w4 + 0x6ED9EBA1
            )
        b = b shl 30 or (b ushr 2)
        ...
        d = (
            (e shl 5 or (e ushr 27)) + (a xor b xor c) +
                d + w5 + 0x6ED9EBA1
            )
        a = a shl 30 or (a ushr 2)
        ...
        c = (
            (d shl 5 or (d ushr 27)) + (e xor a xor b) +
                c + w6 + 0x6ED9EBA1
            )
        e = e shl 30 or (e ushr 2)
        ...
        b = (
            (c shl 5 or (c ushr 27)) + (d xor e xor a) +
                b + w7 + 0x6ED9EBA1
            )
        d = d shl 30 or (d ushr 2)
        ...
        a = (
            (b shl 5 or (b ushr 27)) + (c xor d xor e) +
                a + w8 + 0x6ED9EBA1
            )
        c = c shl 30 or (c ushr 2)
        ...
        w8 = u shl 1 or (u ushr 31)
        e = (
            (a shl 5 or (a ushr 27)) + (b and c or (b and d) or (c and d)) +
                e + w8 + -0x70e44324
            )
        b = b shl 30 or (b ushr 2)
        u = w6 xor w1 xor wb xor w9
        w9 = u shl 1 or (u ushr 31)
        d = (
            (e shl 5 or (e ushr 27)) + (a and b or (a and c) or (b and c)) +
                d + w9 + -0x70e44324
            )
        a = a shl 30 or (a ushr 2)
        u = w7 xor w2 xor wc xor wa
        wa = u shl 1 or (u ushr 31)
        c = (
            (d shl 5 or (d ushr 27)) + (e and a or (e and b) or (a and b)) +
                c + wa + -0x70e44324
            )
        e = e shl 30 or (e ushr 2)
        u = w8 xor w3 xor wd xor wb
        wb = u shl 1 or (u ushr 31)
        b = (
            (c shl 5 or (c ushr 27)) + (d and e or (d and a) or (e and a)) +
                b + wb + -0x70e44324
            )
        d = d shl 30 or (d ushr 2)
        u = w9 xor w4 xor we xor wc
        wc = u shl 1 or (u ushr 31)
        a = (
            (b shl 5 or (b ushr 27)) + (c and d or (c and e) or (d and e)) +
                a + wc + -0x70e44324
            )
        c = c shl 30 or (c ushr 2)
        u = wa xor w5 xor wf xor wd
