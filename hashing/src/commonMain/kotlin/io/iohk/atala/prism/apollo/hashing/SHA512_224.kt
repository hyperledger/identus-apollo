...
import io.iohk.atala.prism.apollo.hashing.internal.Digest
...
/**
 * This class implements the SHA-512/224 digest algorithm under the [MDHelper] API.
 * SHA-512/224 is defined by FIPS 180-4.
 */
final class SHA512_224 : Digest, HMACInterface {
    ...
    private class HashHelper : MDHelper(false, 16) {
        ...
        override fun engineReset() {
            currentVal[0] = -8341449602262348382
            currentVal[1] = 0x73E1996689DCD4D6L
            currentVal[2] = 0x1DFAB7AE32FF9C82L
            currentVal[3] = 0x679DD514582F9FCFL
            currentVal[4] = 0x0F6D2B697BD44DA8L
            currentVal[5] = 0x77E36F7304C48942L
            currentVal[6] = 0x3F9D85A86A1D36C8L
            currentVal[7] = 0x1112E6AD91D692A1L
        }
